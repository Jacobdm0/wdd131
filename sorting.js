...
function hikeSearchList(list, q) {
...
console.log(hikeSearchList(hikes, "yellowstone"));
  console.log(hikeSearchList(hikes, "moderate"));
  console.log(hikeSearchList(hikes, "al"));